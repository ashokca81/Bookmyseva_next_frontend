  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        sacred: "bg-gradient-to-r from-marigold to-marigold-light text-primary-foreground font-semibold shadow-card hover:shadow-glow hover:scale-[1.02]",
        maroon: "bg-gradient-to-r from-maroon to-maroon-dark text-secondary-foreground font-semibold shadow-card hover:shadow-elevated",
        success: "bg-spiritual-green text-success-foreground font-semibold shadow-card hover:bg-spiritual-green-light",
      },
      size: {
